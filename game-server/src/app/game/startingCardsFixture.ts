...
let boar = {name: 'Кабан', maxHp: 4, damage: 2, manaCost: 2, movingPoints: 3, abilities: {firstStrike: true}};
let reptile = {name: 'Ящер', maxHp: 6, damage: 1, manaCost: 2, movingPoints: 3, abilities: {noEnemyRetaliation: true}};
let skeleton = {name: 'Скелет', maxHp: 2, damage: 1, manaCost: 2, movingPoints: 3, abilities: {vampiric: true}};
